...
cur=conn.cursor()
cur.execute("CREATE TABLE products (id INT NOT NULL PRIMARY KEY,name VARCAHR NOT NULL,bp INT,sp INT,serial_no VARCHAR)")
...
cur.execute("CREATE TABLE stock (id INT NOT NULL PRIMARY KEY,product_name VARCHAR NOT NULL,quantity INT NOT NULL,bp FOREIGN KEY(bp) REFERENCES products(bp) ON UPDATE CASCADE NOT NULL,date DATE NOT NULL DEFAULT NOW())")
cur.execute("CREATE TABLE suppliers (id INT NOT NULL PRIMARY KEY,name VARCHAR NOT NULL,location VARCHAR NOT NULL,email_address VARCHAR NOT NULL,address VARCHAR NOT NULL)")
