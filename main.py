...
cur.execute("CREATE TABLE sales (id INT NOT NULL PRIMARY KEY,product_id FOREIGN KEY REFERENCES products(id) ON UPDATE CASCADE NOT NULL,quantity INT,created_at DATE NOT NULL DEFAULT NOW())")
